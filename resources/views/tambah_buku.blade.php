                ...
                <div class="card-body">
                    <form action="books-add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="book_code" placeholder="Masukkan kode buku" value="{{ old('book_code') }}">
                        </div>
                        @error('book_code')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Masukkan judul buku" value="{{ old('title') }}">
                        </div>
                        @error('title')
                        <div class="text-danger mt-0">
                            {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tahun_terbit" placeholder="Masukkan tahun terbit" value="{{ old('tahun_terbit') }}">
                        </div>
                        @error('tahun_terbit')
                        <div class="text-danger mt-0">
                            {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="sinopsis" name="sinopsis" placeholder="Masukkan sinopsis buku" rows="5"></textarea>
                        </div>
                        @error('sinopsis')
                        <div class="text-danger mt-0">
                            {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="stock" placeholder="Masukkan stok buku">
                        </div>
                        @error('stock')
                        <div class="text-danger mt-0">
                            {{ $message }}
