          ...
          <table class="table table-bordered align-items-center table-flush bordered" id="dataTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="/detail-anggota/{{$pengguna->slug}}" class="btn btn-sm btn-primary" title="Detail"><i class="fas fa-info-circle"></i> Detail</a>
                </td>
                <td>
                  <a href="/block-anggota/{{$pengguna->slug}}" class="btn btn-sm btn-danger btn-blokir" title="Blokir Anggota"><i class="fas fa-ban"></i> Blokir Anggota</a>
                </td>
              </tr>
              @endforeach
