...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="/pengguna-edit/{{$users->slug}}" method="post">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <label>Nama Lengkap<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="name" placeholder="Masukkan nama lengkap" value="{{ $users->name }}">
                        </div>
                        @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" placeholder="Masukkan username" value="{{ $users->username }}">
                        </div>
                        @error('username')
                        <div class="text-danger mt-0">
                            {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="phone" placeholder="Masukkan nomer telepon" value="{{ $users->phone }}">
                        </div>
                        @error('phone')
                        <div class="text-danger mt-0">
                            {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="address" placeholder="Masukkan alamat" rows="3">{{ $users->address }}</textarea>
                        </div>
                        @error('address')
                        <div class="text-danger mt-0">
                            {{ $message }}
                        ...
                        <a href="/pengguna" class="btn btn-secondary mt-2">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
